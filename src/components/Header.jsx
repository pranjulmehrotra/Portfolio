    ...
    <header className='flex justify-center items-center text w-full fixed top-0 py-1 left-0 bg-primary z-10'>
      <div className='flex items-center justify-between xl:w-[70%] lg:w-[85%] md:w-[85%] sm:w-[80%] w-[87%]'>
        <div className='text relative'><span className='font-bold owner'>
          <h4 className='p-0 m-0'>Pranjul</h4>
          <h4 className='p-0 m-0'>Mehrotra.</h4><h6 className='trademark'>TM</h6></span>
        </div>
        ...
        <div className={`lg:flex hidden items-center`}>
          ...
          <div className='social-links flex items-center m-2'>
            <a className="links-padding" title = "GitHUB" href='https://github.com/pranjulmehrotra'><UilGithub className="icons" /></a>
            <a className="links-padding" title = "Instagram" href='https://www.instagram.com/pranjulmehrotra/'><UilInstagramAlt className="icons" /></a>
            <a className="links-padding" title = "LinkedIn" href='https://www.linkedin.com/in/pranjul-mehrotra-2731181a0/'><UilLinkedin className="icons" /></a>
            <a className="links-padding" title = "Resume" href='https://drive.google.com/file/d/1x9jINunFYo5wseSpIHtgEI00Qjw9E3lN/view?usp=sharing'><UilFileDownload className="icons" /></a>

          </div>
        </div>
        <button className='connect-button hero-btn px-3 lg:block hidden py-2'><a href="mailto:mehrotra2002pranjul@gmail.com"><span>Let's Connect!</span></a></button>
      ...
      className={` lg:hidden flex-col items-center justify-start absolute top-0 p-10 right-[50%] translate-x-[50%] w-[100vw] bg-primary ${toggle? "hidden":"visible"}`}>
        ...
        <button className='connect-button hero-btn px-4 min-h-[40px] mt-10'><a href="mailto:mehrotra2002pranjul@gmail.com"><span>Let's Connect!</span></a></button>
      </div>
